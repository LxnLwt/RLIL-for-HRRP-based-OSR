...
if __name__ == '__main__':
    ...
    # parser.add_argument('--backbone', type=str, default=['fsbn', 'resnet184', 'alexnet'])
    ...
    parser.add_argument('--loss_f', type=str, default=['cac'])
    parser.add_argument('--optimizer', type=str, default='AdamW')

    # 数据集1
    parser.add_argument('--train_path1', type=str, default="data/9.12/traindata_1378.csv")
    parser.add_argument('--val_path1', type=str, default="data/9.12/testdata_1378.csv")
    parser.add_argument('--known_path1', type=str, default="data/9.12/testdata_1378.csv")
    parser.add_argument('--unknown_path1', type=str, default="data/9.12/testdata_unknown_04569.csv")
    ...
    # 数据集2
    parser.add_argument('--train_path2', type=str, default="data/9.12/traindata_5789.csv")
    parser.add_argument('--val_path2', type=str, default="data/9.12/testdata_5789.csv")
    parser.add_argument('--known_path2', type=str, default="data/9.12/testdata_5789.csv")
    parser.add_argument('--unknown_path2', type=str, default="data/9.12/testdata_unknown_01346.csv")
    ...
    # 数据集3
    parser.add_argument('--train_path3', type=str, default="data/9.12/traindata_sim_5kc.csv")
    parser.add_argument('--val_path3', type=str, default="data/9.12/testdata_sim_5kc.csv")
    parser.add_argument('--known_path3', type=str, default="data/9.12/testdata_sim_5kc.csv")
    parser.add_argument('--unknown_path3', type=str, default="data/9.12/unknown_sim_5kc.csv")
    ...
    # 数据集4
    parser.add_argument('--train_path4', type=str, default="data/9.12/traindata_sim_6kc.csv")
    parser.add_argument('--val_path4', type=str, default="data/9.12/testdata_sim_6kc_27.csv")
    parser.add_argument('--known_path4', type=str, default="data/9.12/testdata_sim_6kc_27.csv")
    parser.add_argument('--unknown_path4', type=str, default="data/9.12/unknown_sim_6kc_27.csv")
    ...
    parser.add_argument('--data_number', type=float, default=[3])
